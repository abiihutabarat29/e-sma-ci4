    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="/data-inventaris/save" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('inventaris')) ? 'has-error' : ''; ?>">
                                    <input name="inventaris" type="text" class="form-control" autocomplete="off" placeholder="Jenis Inventaris" value="<?= old('inventaris'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('dibutuhkan')) ? 'has-error' : ''; ?>">
                                    <input name="dibutuhkan" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Dibutuhkan" value="<?= old('dibutuhkan'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('ada')) ? 'has-error' : ''; ?>">
                                    <input name="ada" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Ada" value="<?= old('ada'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('kurang')) ? 'has-error' : ''; ?>">
                                    <input name="kurang" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Kurang" value="<?= old('kurang'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('lebih')) ? 'has-error' : ''; ?>">
                                    <input name="lebih" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Lebih" value="<?= old('lebih'); ?>">
                                    <small class="form-text text-danger">
