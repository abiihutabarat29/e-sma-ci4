                                            ...
                                            <div class="row">
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group <?= ($validation->hasError('nip')) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="text" class="form-control" id="nip" name="nip" autocomplete="off" value="<?= (old('nip')) ? old('nip') : $data['nip']; ?>" autofocus>
                                                ...
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group <?= ($validation->hasError('nuptk')) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="text" class="form-control" id="nuptk" name="nuptk" autocomplete="off" value="<?= (old('nuptk')) ? old('nuptk') : $data['nuptk']; ?>">
                                                        <small class="form-text text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group <?= ($validation->hasError('nmpegawai')) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="text" class="form-control" id="nmpegawai" name="nmpegawai" autocomplete="off" value="<?= (old('nmpegawai')) ? old('nmpegawai') : $data['nama']; ?>">
                                                        <small class="form-text text-danger">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group <?= ($validation->hasError('jurusan')) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type=" text" name="jurusan" class="form-control" autocomplete="off" value="<?= (old('jurusan')) ? old('jurusan') : $data['jurusan']; ?>">
                                                        <small class="form-text text-danger">
                                                ...
                                                <div class="col-md-6 pr-0">
                                                    <div class="form-group <?= ($validation->hasError('thnijazah')) ? 'has-error' : ''; ?>">
                                                        ...
                                                        <input type="text" name="thnijazah" class="form-control" autocomplete="off" placeholder="example : 2020" value="<?= (old('thnijazah')) ? old('thnijazah') : $data['thnijazah']; ?>">
                                                        <small class="form-text text-danger">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" name="tdiklat" class="form-control" autocomplete="off"><?= (old('tdiklat')) ? old('tdiklat') : $data['tdiklat']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-0">
                                                <div class="form-group">
