                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group <?= ($validation->hasError('tamat')) ? 'has-error' : ''; ?>">
                                        <label>Pilih Siswa</label><span class="text-danger">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>NISN</label><span class="text-danger">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Kelas</label><span class="text-danger">*</span>
                                ...
                                <?php if (session()->get('level') == '1') { ?>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Jurusan</label><span class="text-danger">*</span>
                                ...
                                <?php if (session()->get('level') == '2') { ?>
                                    <div class="col-md-6 pr-0">
                                        <div class="form-group">
                                            <label>Paket Keahlian</label><span class="text-danger">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tahun Masuk</label><span class="text-danger">*</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?= ($validation->hasError('thntamat')) ? 'has-error' : ''; ?>">
                                        <label>Pilih Tahun Tamat</label><span class="text-danger">*</span>
