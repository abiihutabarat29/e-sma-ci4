                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group <?= ($validation->hasError('tamat')) ? 'has-error' : ''; ?>">
                                    <select name="tamat" id="tamatsmk" class="js-example-language" style="width: 40%">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('thntamat')) ? 'has-error' : ''; ?>">
                                    <label>Tahun Tamat / Tahun Pelajaran</label>
                                    <select name="thntamat" class="form-control">
                                        <option selected disabled><?= (old('thntamat')) ? old('thntamat') : ".::Pilih Tahun::." ?></option>
