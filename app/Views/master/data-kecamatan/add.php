    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="<?= base_url('data-kecamatan/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 pr-0">
                                <div class="form-group <?= ($validation->hasError('kode')) ? 'has-error' : ''; ?>">
                                    <input name="kode" type="text" class="form-control" autocomplete="off" placeholder="Kode Wilayah Administratif" value="<?= old('kode'); ?>">
                            ...
                            <div class="col-md-8">
                                <div class="form-group <?= ($validation->hasError('kecamatan')) ? 'has-error' : ''; ?>">
                                    <input name="kecamatan" type="text" class="form-control" autocomplete="off" placeholder="Nama Kecamatan" value="<?= old('kecamatan'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-12">
                                <div class=" form-group <?= ($validation->hasError('kab')) ? 'has-error' : ''; ?>">
                                    <select name="kab" class="js-example-language" style="width: 100%">
                                        <option selected disabled><?= (old('kab')) ? old('kab') : ".::Pilih Kabupaten::." ?></option>
