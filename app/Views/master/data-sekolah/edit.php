    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="<?= base_url('data-sekolah/update/' . $data['id']); ?>" method="post">
                    <?= csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-2 pr-0">
                                <div class="form-group <?= ($validation->hasError('npsn')) ? 'has-error' : ''; ?>">
                                    <input name="npsn" type="text" class="form-control" autocomplete="off" placeholder="NPSN" value="<?= (old('npsn')) ? old('npsn') : $data['npsn']; ?>">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('sekolah')) ? 'has-error' : ''; ?>">
                                    <input name="sekolah" type="text" class="form-control" autocomplete="off" placeholder="Nama Sekolah" value="<?= (old('sekolah')) ? old('sekolah') : $data['sekolah']; ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('kabupaten')) ? 'has-error' : ''; ?>">
                                    <select name="kabupaten" class="js-example-language" style="width: 100%">
                                        <option selected disabled><?= (old('kabupaten')) ? old('kabupaten') : $data['kabupaten'];  ?></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('status')) ? 'has-error' : ''; ?>">
                                    <select name="status" class="form-control">
                                        <option><?= (old('status')) ? old('status') : $data['status_sekolah']; ?></option>
