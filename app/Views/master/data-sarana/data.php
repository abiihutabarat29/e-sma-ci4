        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('data-sarana/add') ?>" class="badge badge-primary btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="add-row" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($datasarana as $key => $r) : ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $r['sarana']; ?></td>
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('data-sarana/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
...
<!-- Modal -->
<?php foreach ($datasarana as $r) { ?>
    <form action="<?= base_url('data-sarana/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Apa kamu yakin ingin menghapus data <span class="text-danger"><?= $r['sarana'] ?></span> ini secara permanen ???
                    </div>
