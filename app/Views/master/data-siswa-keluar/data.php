<?php if (session()->get('status') == 1) : ?>
    ...
    <div class="page-inner mt--5">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="<?= base_url('data-siswa-keluar/add') ?>" class="badge badge-primary btn-sm">
        ...
        <!-- Modal -->
        <?php foreach ($datasiswak as $r) { ?>
            <form action="<?= base_url('data-siswa-keluar/' . $r['id']); ?>" method="post">
                <?= csrf_field(); ?>
