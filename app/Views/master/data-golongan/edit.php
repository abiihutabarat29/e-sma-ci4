    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <form action="<?= base_url('data-golongan/update/' . $data['id']); ?>" method="post">
                    <?= csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-10 pr-0">
                                <div class="form-group <?= ($validation->hasError('golongan')) ? 'has-error' : ''; ?>">
                                    <input name="golongan" type="text" class="form-control" autocomplete="off" placeholder="Golongan" value="<?= (old('golongan')) ? old('golongan') : $data['golongan']; ?>">
