        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('data-golongan/add') ?>" class="badge badge-primary btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="add-row" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($golongan as $key => $r) : ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $r['golongan']; ?></td>
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('data-golongan/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
...
<?php foreach ($golongan as $r) { ?>
    <form action="<?= base_url('data-golongan/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Apa kamu yakin ingin menghapus data <span class="text-danger"><?= $r['golongan'] ?></span> ini secara permanen ???
                    </div>
