        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('data-tahun-akademik/add') ?>" class="badge badge-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('data-tahun-akademik/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
