            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?= base_url('data-arsip-laporan/add') ?>" class="badge badge-primary ml-auto btn-sm">
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <?php if ($r['bulan'] == format_bulan(date('Y-m-d'))) { ?>
                                                        <a href="/data-arsip-laporan/edit/<?= $r['id']; ?>" class="btn btn-link btn-primary btn-lg">
