<?php if (session()->get('status') == 1) : ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="<?= base_url('data-arsip-laporan/add') ?>" class="badge badge-primary btn-sm">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $key => $r) : ?>
                                            <tr>
                                                ...
                                                <td><?= $r['tahun']; ?></td>
                                                <td>
                                                    <center><a href="<?= base_url() ?>/media/arsip-laporan/<?= $r['file']; ?>" target="blank"><button class="btn btn-primary btn-xs"><i class="fa fa-download"></i> Download</button></a></center>
                                                </td>
                                                <td>
                                                    <div class="form-button-action">
                                                        <?php if ($r['bulan'] == format_bulan(date('Y-m-d'))) { ?>
                                                            <a href="<?= base_url('data-arsip-laporan/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
    ...
    <?php foreach ($data as $r) { ?>
        <form action="<?= base_url('data-arsip-laporan/' . $r['id']); ?>" method="post">
            <?= csrf_field(); ?>
