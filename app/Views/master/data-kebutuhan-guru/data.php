<?php if (session()->get('status') == 1) : ?>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="<?= base_url('data-kebutuhan/add') ?>" class="badge badge-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="<?= base_url('data-kebutuhan/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
    ...
    <!-- Modal -->
    <?php foreach ($datakebutuhan as $r) { ?>
        <form action="<?= base_url('data-kebutuhan/' . $r['id']); ?>" method="post">
            <?= csrf_field(); ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Apa kamu yakin ingin menghapus data <span class="text-danger"><?= $r['mapel'] ?></span> ini secara permanen ???
                        </div>
