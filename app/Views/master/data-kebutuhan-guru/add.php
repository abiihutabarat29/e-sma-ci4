    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="/data-kebutuhan/save" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('butuh')) ? 'has-error' : ''; ?>">
                                    <input name="butuh" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Dibutuhkan" value="<?= old('butuh'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('pns')) ? 'has-error' : ''; ?>">
                                    <input name="pns" type="text" class="form-control" autocomplete="off" placeholder="Jumlah PNS" value="<?= old('pns'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('kurang')) ? 'has-error' : ''; ?>">
                                    <input name="kurang" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Kekurangan Guru" value="<?= old('kurang'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('nonpns')) ? 'has-error' : ''; ?>">
                                    <input name="nonpns" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Non-PNS" value="<?= old('nonpns'); ?>">
                                    <small class="form-text text-danger">
                            ...
                            <div class="col-md-6">
                                <div class="form-group <?= ($validation->hasError('lebih')) ? 'has-error' : ''; ?>">
                                    <input name="lebih" type="text" class="form-control" autocomplete="off" placeholder="Jumlah Kelebihan Guru" value="<?= old('lebih'); ?>">
                                    <small class="form-text text-danger">
