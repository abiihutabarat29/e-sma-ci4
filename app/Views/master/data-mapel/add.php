    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="<?= base_url('data-mapel/save') ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 pr-0">
                                <div class="form-group <?= ($validation->hasError('mapel')) ? 'has-error' : ''; ?>">
                                    <input name="mapel" type="text" class="form-control" autocomplete="off" placeholder="Mata Pelajaran" value="<?= old('mapel'); ?>">
