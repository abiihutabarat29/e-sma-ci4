        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="<?= base_url('data-inventaris-barang/add') ?>" class="badge badge-primary btn-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <a href="<?= base_url('data-inventaris-barang/edit/' . $r['id']) ?>" title="Edit" class="btn btn-warning btn-xs mr-2">
...
<?php foreach ($data as $r) { ?>
    <form action="<?= base_url('data-inventaris-barang/' . $r['id']); ?>" method="post">
        <?= csrf_field(); ?>
