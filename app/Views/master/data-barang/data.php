        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url('data-inventaris-barang/add') ?>" class="btn btn-primary btn-round ml-auto btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a href="/data-inventaris-barang/edit/<?= $r['id']; ?>" class="btn btn-link btn-primary btn-lg">
